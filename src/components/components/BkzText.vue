<template>
    <a target="_blank" class="link-a" v-if="type.type === 'link'" :href="highlight">{{highlight}}</a>
    <a @click.prevent="bkzWindow(highlight)" v-else-if="type.type === 'quote'" :href="hrefEntry">{{highlight}}</a>
    <a @click.prevent="bkzWindow(highlight)"  v-else-if="type.type === 'baslik'" :href="hrefEntry">(bkz: {{highlight}})</a>
